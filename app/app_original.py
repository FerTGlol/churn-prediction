...
def risk_pill(p):
    # Multiplicamos por 100 solo para el despliegue en el Frontend
    percentage = p * 100
    if p >= 0.651:
        return f'<span class="pill-red">🔴 {percentage:.1f}%</span>'
    elif p >= 0.331:
        return f'<span class="pill-amber">🟡 {percentage:.1f}%</span>'
    else:
        return f'<span class="pill-green">🟢 {percentage:.1f}%</span>'
